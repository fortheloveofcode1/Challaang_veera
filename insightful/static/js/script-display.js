...
window.addEventListener('DOMContentLoaded', function () {
    ...
    console.log(queryParams); // Output the extracted query parameters to the console
    // Now you can use queryParams object to access the parameters
    fetchQueryResults(queryParams);
});
...
function fetchQueryResults(params) {
    displayMessage("", "", "");
    queryData = null;
